...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
  ...
  [cell.imageButton setBackgroundImage:[UIImage imageNamed:@"home_icon_yw_on"] forState:UIControlStateNormal];
...
- (NSArray *)defaultArray{
  if (!_defaultArray){
    ...
    NSArray *firstRowDefault = [[NSArray alloc] initWithObjects:@"home_icon_yw_on0",@"home_icon_yw_on",@"home_icon_yw_on",@"home_icon_yw_on",@"home_icon_yw_on",nil];
    NSArray *secondRowDefault = [[NSArray alloc] initWithObjects:@"home_icon_yw_on",@"home_icon_yw_on",@"home_icon_yw_on",@"home_icon_yw_on",@"home_icon_yw_on",nil];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
  ...
  if ((indexPath.row == ([[self.dataArray objectAtIndex:indexPath.section] count] - 1))) {
    ...
    NSString *tempImageName = @"home_icon_yw_on";
