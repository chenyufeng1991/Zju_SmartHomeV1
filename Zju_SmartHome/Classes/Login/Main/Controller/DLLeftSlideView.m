...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor colorWithRed:0.224 green:0.231 blue:0.278 alpha:0.8];
        ...
        userPhoto.center = CGPointMake((MAX_CENTER_X - centerX) / 2, 80);
        ...
        [self addSubview:btnChangePhoto];
        ...
        [self addSubview:btnCompleteProfile];
        ...
        [self addSubview:btnModifyPassWord];
        ...
        [self addSubview:btnModifyEmail];
        ...
        [self addSubview:btnAccountLogout];
